...
-- $$ |  $$ |$$ |  $$ |      $$ |\$$$ |$$ |  $$ |  $$ |         $$ |  $$ |$$ |\$$$ |   $$ |   $$ |  $$ |$$ |  $$ |      $$ |  $$ |$$ |      $$ |      $$ |     $$ |  $$ |$$$  / \$$$ |
-- $$$$$$$  | $$$$$$  |      $$ | \$$ | $$$$$$  |  $$ |         \$$$$$$  |$$ | \$$ |   $$ |   $$ |  $$ |\$$$$$$  |      $$$$$$$  |$$$$$$$$\ $$$$$$$$\ $$$$$$$$\ $$$$$$  |$$  /   \$$ |
-- \_______/  \______/       \__|  \__| \______/   \__|          \______/ \__|  \__|   \__|   \__|  \__| \______/       \_______/ \________|\________|\________|\______/ \__/     \__|
                                                                                                                                                                                --    


-- local garagePos = vector3(994.5925, -3002.594, -39.64699)
-- local garageLeavePos = vector3(994.5925, -3002.594, -39.64699)
-- local laptopPos = vector4(964.4495, -3003.59, -39.6399, 94.54449)
-- local garageSlots = 2 -- Initial garage slots
-- local maxGarageSlots = 20 -- Maximum garage slots
-- local upgradeCosts = {
--     {slots = 5, price = 1000},
--     {slots = 10, price = 5000},
--     {slots = 20, price = 10000}
-- } -- Slot levels and their respective prices
...
--     if garageSlots >= maxGarageSlots then
--         ShowNotification("Your garage is already fully upgraded.")
--         return
--     end

--     for _, upgrade in ipairs(upgradeCosts) do
--         if garageSlots < upgrade.slots then
--             -- Trigger server event to deduct money and upgrade the garage
--             TriggerServerEvent(Events.pay, upgrade.price, function(success)
--                 if success then
--                     garageSlots = upgrade.slots  -- Update the local variable for slots
--                     -- Trigger server event to save updated slots
--                     TriggerServerEvent("drift:updateGarageSlots", GetPlayerServerId(PlayerId()), garageSlots)  -- Pass player ID and new slots
--                     ShowNotification("Garage upgraded! You can now store up to " .. garageSlots .. " vehicles.")
--                     LoadCarsinGarage()  -- Reload vehicles based on updated slots
--                 else
--                     ShowNotification("You don't have enough money to upgrade your garage.")
--                 end
--             end)
--             return
--         end
...
-- -- Client-side code
-- RegisterNetEvent("drift:setGarageSlots")
-- AddEventHandler("drift:setGarageSlots", function(slots)
--     print("Updated garage slots on client: " .. slots)
--     garageSlots = slots  -- Update the local variable for garage slots
--     LoadCarsinGarage()  -- Reload vehicles based on the updated slots
-- end)

-- -- -- After saving the new slot count to the database
-- -- TriggerClientEvent("drift:setGarageSlots", src, newSlots)




-- local function IsNearLaptop()
--     local playerPos = GetEntityCoords(PlayerPedId())
--     local dist = #(vector3(playerPos.x, playerPos.y, playerPos.z) - vector3(laptopPos.x, laptopPos.y, laptopPos.z))
--     return dist < 2.0
-- end
...
--         if IsNearLaptop() then
--             ShowHelpNotification("Press ~INPUT_CONTEXT~ to upgrade your garage.")
...
-- local function LoadCarsinGarage()
--     local pVeh = p:GetCars()
--     local maxCars = garageSlots  -- Limit the number of vehicles based on current garage slots

--     for k, v in ipairs(pVeh) do
--         if k > maxCars then break end  -- Only load up to the current garage slots
