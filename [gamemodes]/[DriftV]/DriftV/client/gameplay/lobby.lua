...
function EnableLobby()
    ...
    local function SpawnRandomPlayerVeh()
        ...
        if #vehs > 0 then
            ...
            ClearAreaOfEverything(lobbyVehPos.xy, 50.0, 1, 1, 1, 1)
            local veh = entity:CreateVehicleLocal("chavosv6w", lobbyVehPos.xyz, lobbyVehPos.w)
            FreezeEntityPosition(veh:getEntityId(), true)
            lobbyVeh = veh:getEntityId()
        end
    end
    ...
    Citizen.CreateThread(function()
        ...
        local buttons = {
            ...
            [2] = {
                ...
                text = { baseX = 0.0, baseY = - 0.04 + 0.01, center = true, scale = 1.0, text = "MAP", police = 2},
...
--
                ...
                DrawSprite("sprite", "undo", (baseX - -0.03) + 0.0, (baseY - 0.043) + 0.0, 0.010, 0.015, 0.0, 255, 255, 255, 255)

                DrawTexts(baseX - 0.023, baseY - (0.043) - 0.013, "Go Back", false, 0.35, {255, 255, 255, 255}, 0, 0) -- title
